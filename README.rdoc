...
* gem versions ~> 3.0 for Rails 5.x and 6.x, or the {rails5}[https://github.com/ianheggie/health_check/tree/rails5] stable branch;
* gem versions ~> 2.0 for Rails 4.x, or the {rails4}[https://github.com/ianheggie/health_check/tree/rails4] stable branch;
* gem versions ~> 1.7 for Rails 3.x, or the {rails3}[https://github.com/ianheggie/health_check/tree/rails3] stable branch;
* gem versions ~> 1.6.1 for Rails 2.3, or the {rails2.3}[https://github.com/ianheggie/health_check/tree/rails2.3] stable branch;
