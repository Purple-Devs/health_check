...
As a Gem from rubygems
    ...
    # Add the following line to Gemfile (Rails 3.0 and above)
    gem "health_check"

    # Add the following line to config/environment.rb (Rails 2.3.x)
...
* Rails 1.x is not currently supported (smtp_settings versus server_settings)
