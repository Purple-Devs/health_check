...
Use {rails4}[https://github.com/ianheggie/health_check/tree/rails4] branch or gem versions ~> 3.0 for Rails 4.x;
Use {master}[https://github.com/ianheggie/health_check/tree/master] branch or gem versions ~> 4.0 for Rails 5.x;
